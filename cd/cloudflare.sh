...
# Made by NotFroxyPie
# YouTube: https://youtube.com/@notfroxypie
...
echo -e "${BLUE}${BOLD}║              Made by NotFroxyPie                             ║${NC}"
echo -e "${BLUE}${BOLD}║    YouTube: youtube.com/@notfroxypie                        ║${NC}"
echo -e "${BLUE}${BOLD}║    Discord: discord.gg/ryzencloud                        ║${NC}"
echo -e "${BLUE}${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
...
echo -e "${MAGENTA}${BOLD}    Thanks for using this script by NotFroxyPie!${NC}"
echo -e "${BLUE}${BOLD}════════════════════════════════════════════════════════════${NC}"
