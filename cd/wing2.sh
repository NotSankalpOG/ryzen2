...
║                   ${B_CYAN}${BOLD}Powered by NotFroxyPie${B_BLUE}                   ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝${NC}
"

echo -e "      ${B_CYAN}${BOLD}✨ Script created & maintained by NotFroxyPie ✨${NC}"
echo -e "      ${B_PURPLE}${BOLD}📩 Discord Support: https://discord.gg/ryzencloud${NC}\n"
...
echo
echo -e "\033[0;94m\033[1m🎧 Support Discord:${NC} https://discord.gg/ryzencloud\033[0m"
echo
EOF
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║         ${B_WHITE}${BOLD}Thank you for using NotFroxyPie's Wings Script!${B_BLUE}         ║
║                ${B_CYAN}${BOLD}Join the community & get support:${B_BLUE}                ║
║     ${B_PURPLE}${BOLD}https://discord.gg/ryzencloud${B_BLUE}     ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝${NC}"
