...
#                     2025 Edition
# ===================================================
#  Original Creator: NotFroxyPie
#  YouTube : https://www.youtube.com/@notfroxypie
#  Discord : https://discord.gg/ryzencloud
# ===================================================
...
echo -e "${DIM}      Original Creator: ${BOLD}NotFroxyPie${RESET} ${DIM}| YouTube: @notfroxypie${RESET}"
echo -e "${DIM}      Discord: https://discord.gg/ryzencloud${RESET}"
...
TEMP_REPO="/tmp/ak-notsankalpog-bot"
...
git clone https://github.com/notsankalpog/Vps.git "$TEMP_REPO" >/dev/null 2>&1 || {
...
echo -e "${NEON_GREEN}${BOLD}Original Credits: NotFroxyPie${RESET}"
echo -e "${DIM}YouTube: https://www.youtube.com/@notfroxypie${RESET}"
echo -e "${DIM}Discord: https://discord.gg/ryzencloud${RESET}\n"
